...
const useGroupCategorySubmit = (id) => {
  ...
  const onSubmit = (data) => {
    try {
      ...
      if (id) {
        GroupCategoryServices.updateOne(id, categoryData)
          .then((res) => {
            setIsUpdate(true);
      ...
      GroupCategoryServices.addOne(categoryData)
        .then((res) => {
          setIsUpdate(true);
  ...
  useEffect(() => {
    ...
    if (id) {
      GroupCategoryServices.getById(id)
        .then((res) => {
          if (res) {
...
export default useGroupCategorySubmit;
