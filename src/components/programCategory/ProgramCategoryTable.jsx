...
const service = ProgramCategoryServices

const ProgramCategoryTable = ({ data, isCheck, setIsCheck, currentPage, limitData }) => {
          ...
          <TableRow key={i + 1} className='hover:bg-gray-300'>
            ...
            <TableCell>
              <EditDeleteButton
                ...
                title={item?.name}
                checkPermission={hasPermission("programCategory.delete")}
              />
            </TableCell>
          </TableRow>
        ))}
