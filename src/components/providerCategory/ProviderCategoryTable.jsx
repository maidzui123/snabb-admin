...
const service = ProviderCategoryServices

const ProviderCategoryTable = ({ data, isCheck, setIsCheck, currentPage, limitData }) => {
          ...
          <TableRow key={i + 1} className='hover:bg-gray-300'>
            ...
            <TableCell>
              <EditDeleteButton
                ...
                title={item?.name}
                checkPermission={hasPermission("providerCategory.delete")}
              />
            </TableCell>
          </TableRow>
        ))}
...
export default ProviderCategoryTable;
