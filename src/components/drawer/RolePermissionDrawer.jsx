...
import SelectRolePermission from "@/components/form/SelectRolePermission";
...
const RolePermissionDrawer = ({ id }) => {
  ...
  const fieldArray = React.useMemo(
    () => [
      ...
      {
        label: t("RolePermission description"),
        name: "description",
        type: "textarea",
        rows: "4",
        placeholder: t("RolePermission description"),
        component: "TextAreaCom",
      },
    ],
    []
  ...
  return (
    <>
      <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
        {id ? (
          <Title
            title={t("Update RolePermission")}
            description={t("Updated RolePermission")}
          />
        ) : (
          <Title
            title={t("Add RolePermission")}
            description={t("Add RolePermission")}
          />
        )}
      </div>
