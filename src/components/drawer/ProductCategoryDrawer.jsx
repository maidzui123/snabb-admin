...
import SelectProductCategory from "@/components/form/SelectProductCategory";
...
const ProductCategoryDrawer = ({ id }) => {
  const { register, handleSubmit, onSubmit, errors, isSubmitting } =
    useProductCategorySubmit(id);
  ...
  const fieldArray = React.useMemo(
    () => [
      ...
      {
        label: t("Product Category description"),
        name: "desc",
        type: "textarea",
        rows: "4",
        placeholder: t("Product Category description"),
        component: "TextAreaCom",
      },
    ],
    []
  ...
  return (
    <>
      <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
        {id ? (
          <Title
            title={t("Update ProductCategory")}
            description={t("Updated ProductCategory")}
          />
        ) : (
          <Title
            title={t("Add ProductCategory")}
            description={t("Add ProductCategory")}
          />
        )}
      </div>
                    ...
                    >
                      ...
                      <div className="col-span-8 sm:col-span-4">
                        <Component
                          ...
                          autoFocus={true}
                          disabled={e?.disabled ?? isDisabledComponent("productCategory.update")}
                        />
