...
import useIndustrySubmit from "@/hooks/useIndustrySubmit";
...
const IndustryDrawer = ({ id }) => {
  const { register, handleSubmit, onSubmit, errors, isSubmitting } =
    useIndustrySubmit(id);
  ...
  const fieldArray = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "textarea",
        rows: "4",
        placeholder: t("Industry description"),
        component: TextAreaCom,
        labelRequired: false,
      },
    ],
  ...
  return (
    <>
      <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
        {id ? (
          <Title
            title={t("Update Industry")}
            description={t("Updated Industry")}
          />
        ) : (
          <Title title={t("Add Industry")} description={t("Add Industry")} />
        )}
      </div>
                    ...
                    >
                      ...
                      <div className="col-span-8 sm:col-span-4">
                        <Component
                          ...
                          autoFocus={true}
                          required={true}
                          disabled={e?.disabled ?? isDisabledComponent("industry.update")}
                        />
