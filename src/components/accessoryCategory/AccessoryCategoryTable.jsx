...
const service = AccessoryCategoryServices

const AccessoryCategoryTable = ({ data, isCheck, setIsCheck, currentPage, limitData }) => {
          ...
          <TableRow key={i + 1} className='hover:bg-gray-300'>
            ...
            <TableCell>
              <EditDeleteButton
                ...
                title={item?.name}
                checkPermission={hasPermission("accessoryCategory.delete")}
              />
            </TableCell>
          </TableRow>
        ))}
...
export default AccessoryCategoryTable;
