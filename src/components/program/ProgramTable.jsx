...
const service = ProgramServices;

const ProgramTable = ({ data, isCheck, setIsCheck, currentPage, limitData }) => {
  console.log("🚀 ~ file: ProgramTable.jsx:30 ~ ProgramTable ~ data:", data);
          ...
          <TableRow key={i + 1} className="hover:bg-gray-300">
            ...
            <TableCell>
              <EditDeleteButton
                ...
                title={item?.name}
                checkPermission={hasPermission("program.delete")}
              />
            </TableCell>
          </TableRow>
        ))}
