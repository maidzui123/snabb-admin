...
const service = RetailerCategoryServices

const RetailerCategoryTable = ({ data, isCheck, setIsCheck, currentPage, limitData }) => {
          ...
          <TableRow key={i + 1} className='hover:bg-gray-300'>
            ...
            <TableCell>
              <EditDeleteButton
                ...
                title={item?.name}
                checkPermission={hasPermission("retailerCategory.delete")}
              />
            </TableCell>
          </TableRow>
        ))}
...
export default RetailerCategoryTable;
