...
const Industry = () => {
  ...
  return (
    <>
      <PageTitle>{t("Quản lý ngành hàng")}</PageTitle>
      {isCheck?.length < 2 ? (
        <DeleteModal
          id={serviceId}
      ...
      <BulkActionDrawer ids={allId} title="Industrys" />
      {!serviceData?.length && (
        <MainDrawer>
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="Industry Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="Ngành hàng " />
          )}
        </div>
      </div>
    </>
