...
import AgencyHistoryTable from "@/components/agencyHistory/AgencyHistoryTable";
import SelectCategory from "@/components/form/SelectCategory";
import MainDrawer from "@/components/drawer/MainDrawer";
import AgencyHistoryDrawer from "@/components/drawer/AgencyHistoryDrawer";
import CheckBox from "@/components/form/CheckBox";
import useAgencyHistoryFilter from "@/hooks/useAgencyHistoryFilter";
...
const AgencyHistory = () => {
  ...
  } = useAgencyHistoryFilter(data?.data);

  return (
    <>
      <PageTitle>{t("AgencyHistorys Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ AgencyHistoryServices} />
      <BulkActionDrawer ids={allId} title="AgencyHistorys" />
      {!serviceData?.length && <MainDrawer>
        <AgencyHistoryDrawer id={serviceId} />
      </MainDrawer>}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="AgencyHistory Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="Lịch sử TTSC" />
          )}
        </div>
      </div>
    </>
