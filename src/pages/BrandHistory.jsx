...
import BrandHistoryTable from "@/components/brandHistory/BrandHistoryTable";
import SelectCategory from "@/components/form/SelectCategory";
import MainDrawer from "@/components/drawer/MainDrawer";
import BrandHistoryDrawer from "@/components/drawer/BrandHistoryDrawer";
import CheckBox from "@/components/form/CheckBox";
import useBrandHistoryFilter from "@/hooks/useBrandHistoryFilter";
...
const BrandHistory = () => {
  ...
  } = useBrandHistoryFilter(data?.data);

  return (
    <>
      <PageTitle>{t("BrandHistorys Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ BrandHistoryServices} />
      <BulkActionDrawer ids={allId} title="BrandHistorys" />
      {!serviceData?.length && <MainDrawer>
        <BrandHistoryDrawer id={serviceId} />
      </MainDrawer>}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="BrandHistory Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="BrandHistory" />
          )}
        </div>
      </div>
    </>
