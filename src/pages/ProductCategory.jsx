...
import useProductCategoryFilter from "@/hooks/useProductCategoryFilter";
...
const ProductCategory = () => {
  ...
  } = useProductCategoryFilter(data?.data);
  ...
  return (
    <>
      <PageTitle>{t("ProductCategorys Management")}</PageTitle>
      {isCheck?.length < 2 ? (
        <DeleteModal
          id={serviceId}
          setIsCheck={setIsCheck}
          title={title}
          service={ProductCategoryServices}
        />
      ) : (
        <DeleteModal
          ids={isCheck}
      ...
      <BulkActionDrawer ids={allId} title="ProductCategorys" />
      {!serviceData?.length && (
        <MainDrawer>
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="ProductCategory Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="Phân loại sản phẩm BH" />
          )}
        </div>
      </div>
    </>
