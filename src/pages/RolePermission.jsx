...
import RolePermissionTable from "@/components/rolePermission/RolePermissionTable";
import SelectCategory from "@/components/form/SelectCategory";
import MainDrawer from "@/components/drawer/MainDrawer";
import RolePermissionDrawer from "@/components/drawer/RolePermissionDrawer";
import CheckBox from "@/components/form/CheckBox";
import useRolePermissionFilter from "@/hooks/useRolePermissionFilter";
...
const RolePermission = () => {
  ...
  } = useRolePermissionFilter(data?.data);

  return (
    <>
      <PageTitle>{t("RolePermissions Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ RolePermissionServices} />
      <BulkActionDrawer ids={allId} title="RolePermissions" />
      {!serviceData?.length && <MainDrawer>
        <RolePermissionDrawer id={serviceId} />
      </MainDrawer>}
      ...
      <div className="grid gap-4 md:flex md:justify-between bg-white p-3 m-2 border border-gray-100 rounded-lg">
        <div className="flex justify-start xl:w-1/2 md:w-full">
          ...
          <UploadManyTwo
            ...
            service={ RolePermissionServices}
          />
        </div>
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="RolePermission Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="RolePermission" />
          )}
        </div>
      </div>
    </>
