...
const Module = () => {
  ...
  return (
    <>
      <PageTitle>{t("Modules Management")}</PageTitle>
      {isCheck?.length < 2 ? (
        <DeleteModal
          id={serviceId}
      ...
      <BulkActionDrawer ids={allId} title="Modules" />
      {!serviceData?.length && (
        <MainDrawer>
          <ModuleDrawer id={serviceId} />
        </MainDrawer>
      )}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              <Table>
                <TableHeader>
                  <tr>
                    ...
                    <TableCell>{t("Client URL")}</TableCell>
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="Module Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="Module" />
          )}
        </div>
      </div>
    </>
