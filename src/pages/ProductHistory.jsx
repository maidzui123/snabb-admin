...
import ProductHistoryTable from "@/components/productHistory/ProductHistoryTable";
import SelectCategory from "@/components/form/SelectCategory";
import MainDrawer from "@/components/drawer/MainDrawer";
import ProductHistoryDrawer from "@/components/drawer/ProductHistoryDrawer";
import CheckBox from "@/components/form/CheckBox";
import useProductHistoryFilter from "@/hooks/useProductHistoryFilter";
...
const ProductHistory = () => {
  ...
  } = useProductHistoryFilter(data?.data);

  return (
    <>
      <PageTitle>{t("ProductHistorys Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ ProductHistoryServices} />
      <BulkActionDrawer ids={allId} title="ProductHistorys" />
      {!serviceData?.length && <MainDrawer>
        <ProductHistoryDrawer id={serviceId} />
      </MainDrawer>}
      ...
      {/* <div className="grid gap-4 md:flex md:justify-between bg-white p-3 m-2 border border-gray-100 rounded-lg">
        <div className="flex justify-start xl:w-1/2 md:w-full">
          ...
          <UploadManyTwo
            ...
            service={ ProductHistoryServices}
          />
        </div>
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="ProductHistory Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="ProductHistory" />
          )}
        </div>
      </div>
    </>
