...
import BrandCategoryTable from "@/components/brandCategory/BrandCategoryTable";
import SelectCategory from "@/components/form/SelectCategory";
import MainDrawer from "@/components/drawer/MainDrawer";
import BrandCategoryDrawer from "@/components/drawer/BrandCategoryDrawer";
import CheckBox from "@/components/form/CheckBox";
import useBrandCategoryFilter from "@/hooks/useBrandCategoryFilter";
...
const BrandCategory = () => {
  ...
  } = useBrandCategoryFilter(data?.data);
  ...
  return (
    <>
      <PageTitle>{t("BrandCategorys Management")}</PageTitle>
      {isCheck?.length < 2 ? (
        <DeleteModal
          id={serviceId}
          setIsCheck={setIsCheck}
          title={title}
          service={BrandCategoryServices}
        />
      ) : (
        <DeleteModal
          ids={isCheck}
      ...
      <BulkActionDrawer ids={allId} title="BrandCategorys" />
      {!serviceData?.length && (
        <MainDrawer>
          <BrandCategoryDrawer id={serviceId} />
        </MainDrawer>
      )}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="BrandCategory Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="Phân loại chuỗi cửa hàng " />
          )}
        </div>
      </div>
    </>
