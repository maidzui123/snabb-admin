...
const Contact = () => {
  ...
  } = useContactFilter(data?.data);

  return (
    <>
      <PageTitle>{t("Contacts Management")}</PageTitle>
      <DeleteModal
        ids={allId}
      ...
      />
      <BulkActionDrawer ids={allId} title="Contacts" />
      {!serviceData?.length && (
        <MainDrawer>
          <ContactDrawer id={serviceId} />
        </MainDrawer>
      )}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="Contact Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="Contact" />
          )}
        </div>
      </div>
    </>
