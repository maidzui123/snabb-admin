...
// }
  return (
    <>
      <PageTitle>{t("Tasks Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ TaskServices} />
      <BulkActionDrawer ids={allId} title="Tasks" />
