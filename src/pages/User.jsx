...
const User = () => {
  ...
  } = useUserFilter(data?.data);

  return (
    <>
      <PageTitle>{t("Users Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ UserServices} />
      <BulkActionDrawer ids={allId} title="Users" />
