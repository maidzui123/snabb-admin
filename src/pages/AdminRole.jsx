...
import AdminRoleDrawer from "@/components/drawer/AdminRoleDrawer";
import CheckBox from "@/components/form/CheckBox";
import useAdminRoleFilter from "@/hooks/useAdminRoleFilter";
...
const AdminRole = () => {
  ...
  } = useAdminRoleFilter(data?.data);

  return (
    <>
      <PageTitle>{t("AdminRoles Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={ AdminRoleServices} />
      <BulkActionDrawer ids={allId} title="AdminRoles" />
      {!serviceData?.length && <MainDrawer>
        <AdminRoleDrawer id={serviceId} />
      </MainDrawer>}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="AdminRole Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="AdminRole" />
          )}
        </div>
      </div>
    </>
