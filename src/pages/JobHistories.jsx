...
import JobHistoriesServices from "@/services/JobHistoriesServices";
import PageTitle from "@/components/Typography/PageTitle";
import { SidebarContext } from "@/context/SidebarContext";
import JobHistoriesTable from "@/components/jobHistories/JobHistoriesTable";
import SelectCategory from "@/components/form/SelectCategory";
import MainDrawer from "@/components/drawer/MainDrawer";
import JobHistoriesDrawer from "@/components/drawer/JobHistoriesDrawer";
import CheckBox from "@/components/form/CheckBox";
import useJobHistoriesFilter from "@/hooks/useJobHistoriesFilter";
...
const JobHistories = () => {
  ...
  } = useJobHistoriesFilter(data?.data);

  return (
    <>
      <PageTitle>{t("JobHistoriess Management")}</PageTitle>
      <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} service={JobHistoriesServices} />
      <BulkActionDrawer ids={allId} title="JobHistoriess" />
      {!serviceData?.length && <MainDrawer>
        <JobHistoriesDrawer id={serviceId} />
      </MainDrawer>}
            ...
            <TableContainer className="mb-8 rounded-b-lg">
              ...
              <TableFooter>
                <Pagination
                  ...
                  label="JobHistories Page Navigation"
                />
              </TableFooter>
            </TableContainer>
          ) : (
            <NotFound title="JobHistories" />
          )}
        </div>
      </div>
    </>
